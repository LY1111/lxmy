...
import com.tuansbook.lvxing.Fragment.JingHuaTieFragment;
import com.tuansbook.lvxing.Fragment.ZhiDingTieFragment;
...
public class MyTieZiActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        fragmentList.add(new JingHuaTieFragment());
        fragmentList.add(new ZhiDingTieFragment());
