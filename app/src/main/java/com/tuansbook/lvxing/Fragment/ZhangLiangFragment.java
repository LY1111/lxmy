...
import com.tuansbook.lvxing.Adapter.ZLRecyclerAdapter;
 ...
 * 张梁屋
 */
public class ZhangLiangFragment extends Fragment {

    private SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView recyclerView;
    private ZLRecyclerAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new ZLRecyclerAdapter(getActivity(),tieZiList);
        recyclerView.setAdapter(adapter);

        View header = LayoutInflater.from(getActivity()).inflate(R.layout.zhangliang_recycler_header,recyclerView,false);
