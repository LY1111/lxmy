 ...
 * 侣店-更多商品
 */
public class MoreProductAdapter extends BaseAdapter<Prodruct> {

    private Context context;

    public MoreProductAdapter(Context context, List<Prodruct> prodructList){
    ...
    public RecyclerView.ViewHolder createHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.more_product_inflate,parent,false);
    ...
    public class PHolder extends BaseAdapter.MyHolder{
        ...
        public PHolder(View itemView) {
            ...
            pic = (ImageView) itemView.findViewById(R.id.more_product_pic); // 图片
        }
    }
}
